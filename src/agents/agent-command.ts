...
async function persistAcpTurnTranscriptForTesting(
  params: Parameters<AttemptExecutionRuntime["persistAcpTurnTranscript"]>[0],
): ReturnType<AttemptExecutionRuntime["persistAcpTurnTranscript"]> {
  const attemptExecutionRuntime = await loadAttemptExecutionRuntime();
  return attemptExecutionRuntime.persistAcpTurnTranscript(params);
}
...
export const __testing = {
  ...
  persistAcpTurnTranscript: persistAcpTurnTranscriptForTesting,
};
