...
export function createAgentEventHandler({
  ...
  return (evt: AgentEventPayload) => {
    ...
    if (isToolEvent) {
      ...
      // calls reach subscribed WS UIs. The channelToolPayload strips result/partialResult
      // unless verbose=full; frontend filters by sessionKey.
      if (isControlUiVisible && !suppressHeartbeatToolEvents) {
        broadcast(
          "agent",
          sessionKey
